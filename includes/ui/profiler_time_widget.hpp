...
{
	class ProfilerTimeWidget final : public spk::ContainerWidget
	{
	...
	public:
		ProfilerTimeWidget(std::string name, std::string measurementIdentifier, spk::Widget *parent = nullptr);
	};
}
