...
Preserve the current headless 16³ Chunk world runtime while adapting Chunk to the unified VoxelVolume contract and delegating geometry generation to the common VoxelMesher through a Chunk-aware occlusion resolver.
...
- ChunkOcclusionResolver cross-Chunk lookup
...
|---|---|---|
| Chunk integration with EP-001/EP-032 contracts | [ST-004-01](tickets/ST-004-01-chunk-mesher-integration.md) | [ST-004-01](tickets/ST-004-01-chunk-mesher-integration.md) |
| ChunkOcclusionResolver cross-Chunk lookup and world/local conversion | [ST-004-02](tickets/ST-004-02-chunk-occlusion-resolver.md) | [ST-004-02](tickets/ST-004-02-chunk-occlusion-resolver.md) |
...
- [ST-004-01 — Chunk mesher integration](tickets/ST-004-01-chunk-mesher-integration.md) — Consume the EP-001 Chunk VoxelVolume adaptation and route it into the generic VoxelMesher without creating another adapter.
- [ST-004-02 — Chunk occlusion resolver](tickets/ST-004-02-chunk-occlusion-resolver.md) — Implement meshing context that resolves local out-of-bounds neighbors through Chunk::Collection.
