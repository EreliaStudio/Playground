# OD-014 — Fixed simulation tick rates
...
The project requires an explicit choice for fixed simulation tick rates. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-006](../epics/EP-006-simulation-clocks/EP-006-simulation-clocks.md), [EP-008](../epics/EP-008-exploration-control/EP-008-exploration-control.md). Each affected ticket links back to this record.
