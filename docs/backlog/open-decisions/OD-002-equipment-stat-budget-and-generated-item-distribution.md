# OD-002 — Equipment stat-budget and generated-item distribution
...
The project requires an explicit choice for equipment stat-budget and generated-item distribution. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-018](../epics/EP-018-items-inventory-durability/EP-018-items-inventory-durability.md), [EP-020](../epics/EP-020-crafting-enchantment/EP-020-crafting-enchantment.md). Each affected ticket links back to this record.
