# OD-005 — Defense and critical formulas
...
The project requires an explicit choice for defense and critical formulas. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-013](../epics/EP-013-combat-stats-damage/EP-013-combat-stats-damage.md). Each affected ticket links back to this record.
