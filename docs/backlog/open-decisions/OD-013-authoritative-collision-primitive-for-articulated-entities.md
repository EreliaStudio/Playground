# OD-013 — Authoritative collision primitive for articulated entities
...
The project requires an explicit choice for authoritative collision primitive for articulated entities. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-008](../epics/EP-008-exploration-control/EP-008-exploration-control.md), [EP-009](../epics/EP-009-followers-detection-actions/EP-009-followers-detection-actions.md). Each affected ticket links back to this record.
