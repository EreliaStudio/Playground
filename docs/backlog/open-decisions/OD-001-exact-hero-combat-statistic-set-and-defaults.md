# OD-001 — Exact Hero/combat statistic set and defaults
...
The project requires an explicit choice for exact hero/combat statistic set and defaults. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-007](../epics/EP-007-hero-roster-squad/EP-007-hero-roster-squad.md), [EP-013](../epics/EP-013-combat-stats-damage/EP-013-combat-stats-damage.md). Each affected ticket links back to this record.
