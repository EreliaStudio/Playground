# OD-021 — Serialized derivative mesh cache versus rebuild on load
...
The project requires an explicit choice for serialized derivative mesh cache versus rebuild on load. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-003](../epics/EP-003-runtime-rendering-mesh-cache/EP-003-runtime-rendering-mesh-cache.md), [EP-029](../epics/EP-029-content-contracts/EP-029-content-contracts.md). Each affected ticket links back to this record.
