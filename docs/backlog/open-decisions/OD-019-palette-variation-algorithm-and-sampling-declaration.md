# OD-019 — Palette variation algorithm and sampling declaration
...
The project requires an explicit choice for palette variation algorithm and sampling declaration. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-003](../epics/EP-003-runtime-rendering-mesh-cache/EP-003-runtime-rendering-mesh-cache.md), [EP-033](../epics/EP-033-material-visual-validation/EP-033-material-visual-validation.md). Each affected ticket links back to this record.
