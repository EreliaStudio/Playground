# OD-012 — First external voxel authoring tool and interchange format
...
The project requires an explicit choice for first external voxel authoring tool and interchange format. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-030](../epics/EP-030-external-voxel-import/EP-030-external-voxel-import.md). Each affected ticket links back to this record.
