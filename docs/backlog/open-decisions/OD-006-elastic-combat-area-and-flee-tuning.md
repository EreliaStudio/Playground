# OD-006 — Elastic combat area and flee tuning
...
The project requires an explicit choice for elastic combat area and flee tuning. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-011](../epics/EP-011-combat-area-movement/EP-011-combat-area-movement.md), [EP-012](../epics/EP-012-readiness-turns-flee/EP-012-readiness-turns-flee.md). Each affected ticket links back to this record.
