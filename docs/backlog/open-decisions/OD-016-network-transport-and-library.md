# OD-016 — Network transport and library
...
The project requires an explicit choice for network transport and library. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-028](../epics/EP-028-network-replication/EP-028-network-replication.md). Each affected ticket links back to this record.
