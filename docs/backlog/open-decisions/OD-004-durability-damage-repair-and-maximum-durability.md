# OD-004 — Durability damage, repair, and maximum durability
...
The project requires an explicit choice for durability damage, repair, and maximum durability. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

[EP-018](../epics/EP-018-items-inventory-durability/EP-018-items-inventory-durability.md). Each affected ticket links back to this record.
