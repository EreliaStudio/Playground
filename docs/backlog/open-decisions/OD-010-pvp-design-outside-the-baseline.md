# OD-010 — PvP design outside the baseline
...
The project requires an explicit choice for pvp design outside the baseline. Leaving it implicit would force an implementation ticket to invent design, balance, content, or technology policy.

## Affected epics/tickets

No baseline epic; retained for historical scope control.. Each affected ticket links back to this record.
