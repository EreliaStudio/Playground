# Illustration 03 — Sparse Civilization Across Worlds

**Target output file:** `images/03_sparse_world_civilization.png`  
**GDD section:** 4.2 World Portals / 4.3 Sparse Permanent Civilization / 4.4 Vertical World Progression  
**Suggested placement:** Between 4.3 Sparse Permanent Civilization and 4.4 Vertical World Progression.  
**Intended GDD size:** Full-width  
**Suggested canvas:** 2:1 landscape

## Purpose

Make the geographical pressure of higher Worlds immediately visible: progression does not mean moving through a sequence of equivalent town hubs.
...
Create a horizontal journey composed of **four stylized World slices** connected through portals.

World 1 contains a clearly established permanent town near its portal.

World 2 is mostly wilderness: rugged voxel terrain, dangerous routes, perhaps an outpost crystal or remote dungeon, but **no permanent town**.

World 3 is also wilderness and should feel even more remote, hostile and expedition-like.

World 4 contains another permanent town, visually far removed from the first.

A tiny three-Hero expedition silhouette can appear moving through the chain to reinforce distance and travel.

Higher Worlds should look more formidable through environment and resource/architecture cues, not through displayed level numbers.

## Text inside the image

Only `World 1`, `World 2`, `World 3`, `World 4`.

## Important exclusions

No recommended level numbers, XP indicators, tier badges floating over the Worlds, or implication that every World contains a town.
...
Create **Illustration 03 — Sparse Civilization Across Worlds** for the Erelia Game Design Document.
...
Use the surrounding empty paper space intelligently so the image remains easy to place directly inside a Markdown GDD. Preserve the intended `2:1 landscape` composition. Keep explanatory text to the minimum specified above.
